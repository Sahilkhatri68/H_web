...
function Header_index() {
  ...
  async function CheckLogin() {
    axios
      .get(`${API}/user_login/check_valid_token`, { withCredentials: true })
      .then((res) => {
        setIsLogin(res.data);
  ...
  return (
    <div>
      <nav className="w-full static z-10">
        ...
        <div className="h-[57px] flex  lg:h-[92px] nav_div">
          ...
          <div className="h-[57px] w-full lg:h-[92px] nav_div">
            ...
            <div className="h-[57px] flex justify-between lowernav">
              <div className="hidden lg:flex">
                <ul className="flex items-center text-white">
                  ...
                  >
                    <Link
                      to="/"
                      className="flex font-nunito font-semibold hover:text-[#fb3b3c] text-[15px]"
                    >
                      <p>Home</p>
                      <p className="plus">&nbsp;+</p>
                  ...
                  <li
                    className="px-[9px] li"
                    onMouseOver={function () {
                      document.getElementsByClassName("plus")[1].style.display =
                        "none";
                      document.getElementsByClassName(
                        "minus"
                  ...
                  <li
                    className="px-[9px] li"
                    onMouseOver={function () {
                      document.getElementsByClassName("plus")[2].style.display =
                        "none";
                      document.getElementsByClassName(
                        "minus"
                      )[2].style.display = "block";
                      document.getElementById(
                        "dropdown_it_solution"
                      ).style.display = "block";
                      if (window.scrollY > 0) {
                        document.getElementById(
                          "dropdown_it_solution"
                  ...
                  <li
                    className="px-[9px] li"
                    onMouseOver={function () {
                      document.getElementsByClassName("plus")[3].style.display =
                        "none";
                      document.getElementsByClassName(
                        "minus"
                  ...
                  <li
                    className="px-[9px] li"
                    onMouseOver={function () {
                      document.getElementsByClassName("plus")[4].style.display =
                        "none";
                      document.getElementsByClassName(
                        "minus"
                  ...
                  <li
                    className="px-[9px] li"
                    onMouseOver={function () {
                      document.getElementsByClassName("plus")[5].style.display =
                        "none";
                      document.getElementsByClassName(
                        "minus"
              ...
              <div
                className="w-full flex justify-end md:justify-center md:items-center mr-3 menu_icon cursor-pointer lg:hidden"
                onClick={function () {
                  if (
                    document.getElementsByClassName("mobile_menu")[0].style
                      .height == "0px"
                  ) {
                    document.getElementsByClassName(
                      "mobile_menu"
              ...
              <div className="flex">
                ...
                {isLogin === true ? (
                  <Link to="/user-admin">
                    <div
                      className="hidden md:flex w-[163px] bg-[#0049d0] blinkdiv cursor-pointer text-white h-[57px]"
                      onMouseOver={function () {
                        document.getElementsByClassName(
                          "blink"
                        )[0].style.width = "32px";
        ...
        <div className="fixed bg-white mobile_menu h-0 overflow-hidden lg:hidden w-full">
          <ul className="">
            <li className="li">
              <Link
                to="/"
                className="flex font-nunito font-semibold text-[#0d2c13] hover:text-[#0049d0] hover:font-normal text-[15px] justify-between hover:bg-[#fb3b3c1a] px-2 py-3"
              >
                <p>Home</p>
                <p className="plus">+</p>
              </Link>
        ...
        <div
          id="dropdown_it_solution"
          className="absolute left-[400px] top-[75px]  hidden p-6"
          onMouseOver={function () {
            document.getElementById("dropdown_it_solution").style.display =
              "block";
          }}
          onMouseOut={function () {
            document.getElementById("dropdown_it_solution").style.display =

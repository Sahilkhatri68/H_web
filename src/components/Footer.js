  ...
  return (
    <div>
        ...
        <div className="sm:w-[550px] md:w-[700px] lg:flex items-center lg:w-[900px] xl:w-[1100px] m-auto">
          <div className="bg-white lg:w-1/2 sm:flex justify-between p-[15px]">
            <div>
              <input
                type="text"
                className="placeholder:text-[14px] placeholder:leading-[26px] placeholder:text-[#0d2c13] placeholder:font-normal border border-white hover:border-white hover:border px-4 h-[60px]"
      ...
      >
          ...
          <div className="sm:max-w-[575px] md:max-w-[767px] lg:max-w-[1000px] xl:max-w-[1280px] lg:flex">
            <div className="lg:w-[30%] p-8 bg-white shadow-lg rounded-lg">
              <div className="flex justify-center items-center h-[57px] w-[220px] bg-white px-[25px] cup lg:h-[92px]">
                <p className="font-normal text-[50px] leading-[56px] text-[#0049d0]">
                  .Harsha
                </p>
                <p className="font-normal text-[50px] leading-[56px] text-black">
                  Web
                </p>
              </div>
              <p className="font-nunito font-normal text-[15px] leading-[26px] text-[#0d2c13]">
                HarshaWeb - IT Solution and Services , modern solutions for Your
                business.
              </p>
              <div className="flex mt-4 items-center">
                <svg
                  ...
                  height={16}
                  fill="currentColor"
                  className="bi bi-geo-alt fill-[#0049d0] mr-2"
                  viewBox="0 0 16 16"
                >
              ...
              <div className="flex mt-4 items-center">
                <svg
                  ...
                  height={16}
                  fill="currentColor"
                  className="bi bi-envelope-paper fill-[#0049d0] mr-2"
                  viewBox="0 0 16 16"
                >
                ...
                <a
                  href=""
                  className="font-nunito font-normal text-[16px] leading-[27px] text-[#0d2c13] hover:text-[#0049d0] hover:underline transition-all"
                >
                  info@harshaweb.com
                </a>
              </div>
              <div className="flex mt-4 items-center">
                <svg
                  ...
                  height={16}
                  fill="currentColor"
                  className="bi bi-telephone fill-[#0049d0] mr-2"
                  viewBox="0 0 16 16"
                >
                ...
                <div className="sm:w-[50%] p-6">
                  ...
                  <ul className="">
                    ...
                    >
                      <a
                        href=""
                        className="flex items-center font-nunito font-medium text-[16px] leading-[26px] text-[#0d2c13] hover:text-[#0049d0]"
                      >
              ...
              <div className="w-full md:w-[40%] p-8">
                ...
                <div className="mt-3 flex">
                  ...
                  <div>
                    ...
                    <a
                      href=""
                      className="font-nunito font-semibold text-[15px] leading-[26px] text-[#0d2c13] hover:text-[#0049d0]"
                    >
                      Latest project delivered with client satisfaction
                    </a>
                  </div>
                </div>
                <div className="mt-2 flex">
                  <div className="h-[100px] w-[100px] mr-2">
                    <img
                      src={latest_news_image2}
                      alt="some desc"
                      className="h-[80px] min-w-[80px]"
                    />
                  </div>
                  <div>
                    <p className="font-nunito font-normal text-[15px] leading-[26px] text-[#0049d0]">
                      5th Aug, 2022
                    </p>
                    <a
                      href=""
                ...
                <div className="mt-2 flex">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="font-nunito font-semibold text-[15px] leading-[26px] text-[#0d2c13] hover:text-[#0049d0]"
                    >
                      A brand for a company is like reputation person
                    </a>
                  </div>
                </div>
              </div>
        ...
        <hr />
        <div className="text-center flex justify-center items-center h-[80px] font-semibold text-[16px] leading-[26px] text-[#7a7a7a]">
          Copyright ©2022 All rights reserved | HarshaWeb
          <div className="h-[40px] w-[40px] flex justify-center items-center">
            <svg
              ...
              height={16}
              fill="currentColor"
              className="bi bi-suit-heart fill-[#fb3b3c] animate-beat"
              viewBox="0 0 16 16"
            >
